...
public class PublicChatRoom extends JFrame {
	...
	private void extracted() {
		...
		btnVote.setIcon(new ImageIcon(
				PublicChatRoom.class.getResource("/Image/\uCC44\uD305\uCC3D \uD22C\uD45C \uBC84\uD2BC.png")));
		...
		sendFileBtn.setIcon(new ImageIcon(
				PublicChatRoom.class.getResource("/Image/\uD30C\uC77C\uBCF4\uB0B4\uAE30 \uBC84\uD2BC.png")));
...
//			senderIdLbl.setFont(new Font("굴림", Font.PLAIN, 12));
		...
		fileLabel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int result = JOptionPane.showConfirmDialog(PublicChatRoom.this, "다운받으시겠습니까?", "파일다운",
