...
public class Ranking extends JFrame {
	...
	public void RankingView(User user) {
		...
		lbl_1stImage.setBounds(85, 60, 40, 40);
		lbl_2ndImage.setBounds(85, 102, 40, 40);
		lbl_3rdImage.setBounds(85, 143, 40, 40);
		lbl_4thImage.setBounds(85, 180, 40, 40);
		lbl_5thImage.setBounds(84, 225, 40, 40);
		lbl_1st.setBounds(140, 72, 150, 20);
		lbl_2nd.setBounds(140, 110, 150, 20);
		lbl_3rd.setBounds(140, 152, 150, 20);
		lbl_4th.setBounds(140, 189, 150, 20);
